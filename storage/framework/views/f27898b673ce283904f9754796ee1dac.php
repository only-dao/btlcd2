    ...
    <div class="row">
        <div class="col-lg-4" style="padding: 15px!important;">
            <div style="background-color: #2885BA" class="service-list__content-box">
                <img src="<?php echo e(asset('frontend/img/svmeo.jpg')); ?>" alt="">
                <h3 class="h1-title">
                    CHÍNH SÁCH ĐỔI TRẢ
                </h3>
...
Sản phẩm còn đầy đủ phụ kiện, quà tặng khuyến mại
        ...
        <div class="col-lg-4" style="padding: 15px!important;">
            <div style="background-color: #B56256" class="service-list__content-box">
                <img src="<?php echo e(asset('frontend/img/svmeo2.jpg')); ?>" alt="">
                <h3 class="h1-title">
        ...
        <div class="col-lg-4" style="padding: 15px!important;">
            <div style="background-color: #5C9CCA" class="service-list__content-box">
                <img src="<?php echo e(asset('frontend/img/svmeo3.jpg')); ?>" alt="">
                <h3 class="h1-title">
                    CHÍNH SÁCH BẢO HÀNH
                </h3>
    ...
    <div class="service-text mb30">
        ...
        <div class="d-flex justify-content-center align-items-center">
            <img class="banner-service" src="<?php echo e(asset('frontend/img/svbg.jpg')); ?>" alt="">

        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\chuyendetn1\baitaplon\btl\webdocau\resources\views/pages/services.blade.php ENDPATH**/ ?>