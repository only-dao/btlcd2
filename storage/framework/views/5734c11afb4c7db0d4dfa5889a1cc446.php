      ...
      <nav id="sidebar" class="sidebar js-sidebar">
        <div class="sidebar-content js-simplebar">
          <a class="sidebar-brand" href="<?php echo e(URL::to('/dashboard')); ?>">
            <span class="align-middle">Shop Bán đồ câu cá</span>
          </a>
          ...
          <ul class="sidebar-nav">
            ...
            <li class="sidebar-item">
                <a class="sidebar-link" href="<?php echo e(URL::to('/admin/danhmuc')); ?>">
          ...
          <div class="navbar-collapse collapse">
            <ul class="navbar-nav navbar-align">
              ...
              <li class="nav-item dropdown">
                ...
                >
                  <img
                    src="<?php echo e(asset('backend/img/avatars/avatar.jpg')); ?>"
                ...
                <div class="dropdown-menu dropdown-menu-end">
                  ...
                  >
                  <div class="dropdown-divider"></div>
                  <a class="dropdown-item" href="<?php echo e(URL::to('/admin_logout')); ?>"><i class="align-middle me-2" data-feather="log-out"></i> <span class="align-middle">log-out</span></a>
                </div>
              </li>
            </ul>
          </div>
...
<?php /**PATH D:\chuyendetn1\baitaplon\btl\webdocau\resources\views/admin_layout.blade.php ENDPATH**/ ?>